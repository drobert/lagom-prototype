...
/**
  * This is an event sourced entity. It has a state, [[LagomdemoState]], which
  ...
  */
class LagomdemoEntity extends PersistentEntity {

  override type Command = LagomdemoCommand[_]
  override type Event = LagomdemoEvent
  override type State = LagomdemoState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: LagomdemoState = LagomdemoState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case LagomdemoState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        LagomdemoState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class LagomdemoState(message: String, timestamp: String)

object LagomdemoState {
  /**
    ...
    */
  implicit val format: Format[LagomdemoState] = Json.format
}

/**
  * This interface defines all the events that the LagomdemoEntity supports.
  */
sealed trait LagomdemoEvent

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends LagomdemoEvent
...
/**
  ...
  */
sealed trait LagomdemoCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends LagomdemoCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends LagomdemoCommand[String]
...
/**
  ...
  * application loader.
  */
object LagomdemoSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[LagomdemoState]
  )
}
